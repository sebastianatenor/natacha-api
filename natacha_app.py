...
# --- auto-mount any extra APIRouter exposed by routes.ops_routes ---
try:
    import inspect
    from fastapi import APIRouter
    import routes.ops_routes as _ops_mod
    for _name, _val in vars(_ops_mod).items():
        if isinstance(_val, APIRouter) and _val is not ops_routes.router:
            app.include_router(_val)
except Exception as _e:
    print("### DEBUG: auto-mount extra ops routers failed:", _e)
# --- end auto-mount ---
